...
total_docs = df.count()
if total_docs >= n:
    # sample without replacement (or you could just take first n if the data is shuffled)
    df = df.sample(fraction=(1.0 * n / total_docs), seed=42).limit(n)
else:
    # If dataset has fewer than n docs, use all
    n = total_docs
